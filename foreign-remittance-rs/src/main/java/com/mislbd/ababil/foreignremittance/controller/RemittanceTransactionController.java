...
public class RemittanceTransactionController {
    ...
    public ResponseEntity<?> getTransactions(
            ...
            @RequestParam(value = "globalTransactionNo", required = false) final String globalTransactionNo,
            @RequestParam(value = "remittanceType", required = false) final RemittanceType remittanceType,
            @RequestParam(value = "transactionReferenceNumber", required = false) final String transactionReferenceNumber,
    ...
    public ResponseEntity<CommandResponse<String>> correctionRemittanceTransaction(
        ...
        return status(ACCEPTED)
                .body(commandProcessor.executeResult(new RemittanceTransactionCorrectionCommand(voucherNumber)));
    }
