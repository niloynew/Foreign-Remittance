...
public class KafkaConsumer {
    ...
    public KafkaConsumer(CommandProcessor commandProcessor) {
    ...
    public void receiveMessage(ConsumerRecord<String, Object> consumerRecord) {
        ...
        try {
            NostroReconcileDtoList reconcileDtoList = (NostroReconcileDtoList) JsonConverter.jsonDeserializer(NostroReconcileDtoList.class, consumerRecord.value().toString());
