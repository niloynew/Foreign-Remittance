...
@Service
public class ShadowTransactionServiceImpl implements ShadowTransactionRecordService {
  ...
  public ShadowTransactionServiceImpl(ShadowAccountRepository shadowAccountRepository, ShadowTransactionRecordRepository shadowTransactionRecordRepository, ShadowTransactionRecordMapper shadowTransactionRecordMapper) {
  ...
  @Override
  public PagedResult<ShadowTransactionRecord> getAccountStatement(Pageable pageable, String shadowAccountNumber, LocalDate fromDate, LocalDate toDate) {
