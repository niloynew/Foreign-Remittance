...
public class AccountStatementServiceImpl implements AccountStatementService {
	...
	@Override
	public PagedResult<AccountStatement> getUnreconciledTransactionData(Pageable pageable, String accountNumber, LocalDate fromDate, LocalDate toDate, NostroReconcileStatus reconcileStatus) {
		...
		return PagedResultBuilder.build(accountStatementRepository.findAll(
				AccountStatementSpecification.searchSpecification(
						(accountEntity != null ? accountEntity.getId() : null), fromDate, toDate, reconcileStatus),
				pageable),
				accountStatementMapper.entityToDomain());
	}
