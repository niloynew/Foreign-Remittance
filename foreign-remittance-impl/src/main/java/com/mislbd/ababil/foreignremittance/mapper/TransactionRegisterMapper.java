...
public class TransactionRegisterMapper {
    ...
    public ResultMapper<CbsTransaction, TransactionRegisterEntity> cbsDomainEntity(){
        return txn -> new TransactionRegisterEntity()
    ...
    public ResultMapper<TransactionRegisterEntity, TransactionRegister> entityToDomain(){
        return entity -> new TransactionRegister()
