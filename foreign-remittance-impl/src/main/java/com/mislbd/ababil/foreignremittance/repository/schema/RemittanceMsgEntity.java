...
public class RemittanceMsgEntity extends BaseEntity implements Serializable {
    ...
    public RemittanceMsgEntity setOrderingCustomerNameAndAddress(String orderingCustomerNameAndAddress) {
    ...
    public RemittanceMsgEntity setSendersCorrespondentNameAndAddress(String sendersCorrespondentNameAndAddress) {
    ...
    public RemittanceMsgEntity setReceiversCorrespondentNameAndAddress(String receiversCorrespondentNameAndAddress) {
    ...
    public RemittanceMsgEntity setAccountWithInstitutionNameAndAddress(String accountWithInstitutionNameAndAddress) {
