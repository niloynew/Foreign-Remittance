...
public class ApiTransactionMapper {
    ...
    public ResultMapper<List<CbsTemplateTransaction>, ApiTransactionRequest> cbsTransactionToApiRequest() {
        return transactions -> new ApiTransactionRequest()
                .setApiTransactions(transactions.stream().map(txn -> new ApiTransaction()
                        ...
                        .setTransactionJournalType(txn.getTransactionEntryType().equals(TransactionEntryType.Debit) ? TransactionJournalType.Debit : TransactionJournalType.Credit)
