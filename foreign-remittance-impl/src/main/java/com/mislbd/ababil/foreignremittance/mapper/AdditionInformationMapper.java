...
public class AdditionInformationMapper {
  ...
  public ResultMapper<RemittanceAdditionalInformation, RemittanceAdditionalInformationEntity>
    ...
    .setInstructionCodeAdditionalInformation(domain.getInstructionCodeAdditionalInformation())
    ...
    .setOrderingInstitutionPartyNameAndAddress(domain.getOrderingInstitutionPartyNameAndAddress())
    ...
    .setSelectedReceiversCorrespondentOption(domain.getSelectedReceiversCorrespondentOption())
    .setReceiversCorrespondentPartyIdentifier(domain.getReceiversCorrespondentPartyIdentifier())
    .setReceiversCorrespondentIdentifierCode(domain.getReceiversCorrespondentIdentifierCode())
    .setReceiversCorrespondentLocation(domain.getReceiversCorrespondentLocation())
    .setReceiversCorrespondentNameAndAddress(domain.getReceiversCorrespondentNameAndAddress())
    .setSelectedThirdReimbursementInstitutionOption(domain.getSelectedThirdReimbursementInstitutionOption())
    .setThirdReimbursementInstitutionPartyIdentifier(domain.getThirdReimbursementInstitutionPartyIdentifier())
    .setThirdReimbursementInstitutionIdentifierCode(domain.getThirdReimbursementInstitutionIdentifierCode())
    .setThirdReimbursementInstitutionLocation(domain.getThirdReimbursementInstitutionLocation())
    .setThirdReimbursementInstitutionNameAndAddress(domain.getThirdReimbursementInstitutionNameAndAddress())
    .setSelectedIntermediaryInstitutionOption(domain.getSelectedIntermediaryInstitutionOption())
    .setIntermediaryInstitutionPartyIdentifier(domain.getIntermediaryInstitutionPartyIdentifier())
    .setIntermediaryInstitutionIdentifierCode(domain.getIntermediaryInstitutionIdentifierCode())
    .setIntermediaryInstitutionIdentifierNameAndAddress(domain.getIntermediaryInstitutionIdentifierNameAndAddress())
    .setSelectedAccountWithInstitutionOption(domain.getSelectedAccountWithInstitutionOption())
    .setAccountWithInstitutionPartyIdentifier(domain.getAccountWithInstitutionPartyIdentifier())
    .setAccountWithInstitutionIdentifierCode(domain.getAccountWithInstitutionIdentifierCode())
    .setAccountWithInstitutionPartyLocation(domain.getAccountWithInstitutionIdentifierCode())
    .setAccountWithInstitutionPartyNameAndAddress(domain.getAccountWithInstitutionPartyNameAndAddress());
  }
    ...
    return entity ->
        new RemittanceAdditionalInformation()
            ...
            .setInstructedAmount(
                ...
                .setInstructionCodeAdditionalInformation(entity.getInstructionCodeAdditionalInformation())
                ...
                .setOrderingInstitutionPartyNameAndAddress(entity.getOrderingInstitutionPartyNameAndAddress())
                ...
                .setSelectedReceiversCorrespondentOption(entity.getSelectedReceiversCorrespondentOption())
                .setReceiversCorrespondentPartyIdentifier(entity.getReceiversCorrespondentPartyIdentifier())
                .setReceiversCorrespondentIdentifierCode(entity.getReceiversCorrespondentIdentifierCode())
                .setReceiversCorrespondentLocation(entity.getReceiversCorrespondentLocation())
                .setReceiversCorrespondentNameAndAddress(entity.getReceiversCorrespondentNameAndAddress())
                .setSelectedThirdReimbursementInstitutionOption(entity.getSelectedThirdReimbursementInstitutionOption())
                .setThirdReimbursementInstitutionPartyIdentifier(entity.getThirdReimbursementInstitutionPartyIdentifier())
                .setThirdReimbursementInstitutionIdentifierCode(entity.getThirdReimbursementInstitutionIdentifierCode())
                .setThirdReimbursementInstitutionLocation(entity.getThirdReimbursementInstitutionLocation())
                .setThirdReimbursementInstitutionNameAndAddress(entity.getThirdReimbursementInstitutionNameAndAddress())
                .setSelectedIntermediaryInstitutionOption(entity.getSelectedIntermediaryInstitutionOption())
                .setIntermediaryInstitutionPartyIdentifier(entity.getIntermediaryInstitutionPartyIdentifier())
                .setIntermediaryInstitutionIdentifierCode(entity.getIntermediaryInstitutionIdentifierCode())
                .setIntermediaryInstitutionIdentifierNameAndAddress(entity.getIntermediaryInstitutionIdentifierNameAndAddress())
                .setSelectedAccountWithInstitutionOption(entity.getSelectedAccountWithInstitutionOption())
                .setAccountWithInstitutionPartyIdentifier(entity.getAccountWithInstitutionPartyIdentifier())
                .setAccountWithInstitutionIdentifierCode(entity.getAccountWithInstitutionIdentifierCode())
                .setAccountWithInstitutionPartyLocation(entity.getAccountWithInstitutionIdentifierCode())
                .setAccountWithInstitutionPartyNameAndAddress(entity.getAccountWithInstitutionPartyNameAndAddress());
  }
}
