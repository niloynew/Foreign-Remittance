    ...
    public MT103MessageRequest mapTransactionToMessageRequest(
        ...
        request.setSenderToReceiverInformation(
                remittanceTransaction.getCommodityDescription() != null
                        ...
                        : "");
        RemittanceAdditionalInformation remittanceAdditionalInformation = remittanceTransaction.getRemittanceAdditionalInformation();
        request.setInstructedAmount(remittanceAdditionalInformation.getInstructedAmount());
        request.setInstructedCurrency(remittanceAdditionalInformation.getInstructedCurrency());
        return request;
    }
}
