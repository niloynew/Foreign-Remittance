...
public class SwiftRegisterServiceImpl implements SwiftRegisterService {
  ...
  public MT103MessageRequest getMessageRequestByRegisterId(Long id) {
    ...
    return transactionToRequestMapper.mapTransactionToMessageRequest(remittanceTransaction,swiftRegister.getSenderAddress(),swiftRegister.getReceiverAddress());
  }
}
