...
public class UpdateSwiftRegisterCommandHandlerAggregate {
    ...
    public UpdateSwiftRegisterCommandHandlerAggregate(SwiftRegisterRepository swiftRegisterRepository, SwiftRegisterMapper swiftRegisterMapper, Auditor auditor) {
    ...
    public CommandResponse<Void> updateRegister(UpdateSwiftRegisterCommand command) {
        swiftRegisterRepository.save(
                swiftRegisterMapper.domainToEntity().map(command.getPayload()));
