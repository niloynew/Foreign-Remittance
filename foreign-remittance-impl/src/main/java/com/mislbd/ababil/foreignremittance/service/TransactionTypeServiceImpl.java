...
public class TransactionTypeServiceImpl implements TransactionTypeService {
    ...
    public TransactionTypeServiceImpl(
            ...
            RemittanceTransactionRepository remittanceTransactionRepository, TransactionBanksRepository transactionBanksRepository, TransactionTypeMapper transactionTypeMapper, RemittanceTransactionMapper remittanceTransactionMapper, NostroTransactionRepository nostroTransactionRepository) {
...
//    //NostroTransaction nostroTransaction = nostroTransactionRepository.findById(id).orElseThrow(RemittanceTransactionNotFoundException::new);
