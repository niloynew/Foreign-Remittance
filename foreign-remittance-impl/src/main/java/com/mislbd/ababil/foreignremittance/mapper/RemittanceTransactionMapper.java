...
public class RemittanceTransactionMapper {
    ...
    public RemittanceTransactionMapper(RemittanceTransactionRepository remittanceTransactionRepository) {
    ...
    private List<BankInformation> getConvertedBankInformation(List<BankInformationEntity> bankInformationEntities) {
    ...
    public ResultMapper<RemittanceTransaction, RemittanceTransactionEntity> domainToEntity() {
        return domain ->
                remittanceTransactionRepository.findById(Long.valueOf(domain.getId()))
                        ...
                        .setBankInformationEntity(getConvertedBankInformationEntity(domain.getBankInformation()))
    ...
    private List<BankInformationEntity> getConvertedBankInformationEntity(List<BankInformation> bankInformations) {
