...
public class RemittanceMsgDto {
  ...
  public RemittanceMsgDto setSendersCorrespondentNameAndAddress(
  ...
  public RemittanceMsgDto setReceiversCorrespondentNameAndAddress(
  ...
  public RemittanceMsgDto setAccountWithInstitutionNameAndAddress(
  ...
  public RemittanceMsgDto setBeneficiaryInfo(String beneficiaryInfo) {
  ...
  public RemittanceMsgDto setEntryDate(LocalDate entryDate) {
